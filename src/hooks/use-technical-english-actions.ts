...
export function useTechnicalEnglishActions(refresh: () => void) {
  const createItem = useCallback(
    async (input: CreateTechnicalEnglishInput) => {
      const { createTechnicalEnglishItem } = await import("@/lib/application/technical-english");
  ...
  const updateItem = useCallback(
    async (id: string, input: UpdateTechnicalEnglishInput) => {
      const { updateTechnicalEnglishItem } = await import("@/lib/application/technical-english");
  ...
  const toggleFavorite = useCallback(
    async (id: string) => {
      const { toggleTechEnglishFavorite } = await import("@/lib/application/technical-english");
  ...
  const archiveItem = useCallback(
    async (id: string) => {
      const { archiveTechnicalEnglishItem } = await import("@/lib/application/technical-english");
  ...
  const savePractice = useCallback(
    async (itemId: string, response: string) => {
      const { saveTechEnglishPractice } = await import("@/lib/application/technical-english");
  ...
  const markForReview = useCallback(async (itemId: string) => {
    const { createTechEnglishReview } = await import("@/lib/application/technical-english");
